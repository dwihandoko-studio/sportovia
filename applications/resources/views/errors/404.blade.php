...
<body>
	<!--start-wrap-->
		<div class="wrap">
			<!--start-content-->
			<div class="content">
				<img src="{{ asset('amadeo/main-image/404/error-img.png') }}" title="error" />
				<p><span><label>O</label>hh.....</span>You Requested the page that is no longer There.</p>
				<a href="{{ Route('frontend.home') }}">Back To Home</a>
				<div class="copy-right">
					<p>&#169 All rights Reserved | Designed by <a href="http://w3layouts.com/">W3Layouts</a> | Developer By <a href="http://amadeo.id/">Amadeo</a></p>
				</div>
   			</div>
			<!--End-Cotent-->
		</div>
