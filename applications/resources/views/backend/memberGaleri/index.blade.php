...
@section('title')
<title>Sportopia | Member Gallery</title>
@endsection
...
<div id="content-header">
  <div id="breadcrumb">
    ...
    <a href="" class="current">Member Gallery</a>
  </div>
...
<div class="widget-box">
  <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
    <h5>Member Gallery</h5>
    <a href="{{ route('member.index') }}" class="btn btn-primary pull-right"><i class="icon-plus"></i> Back</a>
  </div>
  <div class="widget-content" style="overflow-x:auto;">
    <form class="form-horizontal" method="post" action="{{ route('memberGaleri.store') }}" name="upload_gallery" enctype="multipart/form-data">
    {{ csrf_field() }}
...
<script type="text/javascript">
  ...
  $(function(){
    $('a.delete').click(function(){
      ...
      $('.delete').attr('href', "{{ url('/') }}/admin/member-gallery/delete/"+a);
    });
  });
