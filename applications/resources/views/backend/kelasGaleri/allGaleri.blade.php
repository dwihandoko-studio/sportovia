...
@section('title')
<title>Sportopia | Gallery Class Course</title>
@endsection
...
<div id="content-header">
  <div id="breadcrumb">
    ...
    <a href="" class="current">Gallery Class Course</a>
  </div>
  <h1>Gallery Class Course</h1>
</div>
@endsection
...
<script type="text/javascript">
  ...
  $(function(){
    $('a.delete').click(function(){
      ...
      $('.delete').attr('href', "{{ url('/') }}/admin/class-gallery/deletee/"+a);
    });
  });
