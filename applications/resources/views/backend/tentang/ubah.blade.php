...
<div id="content-header">
  <div id="breadcrumb">
    ...
    <a href="" class="current">Edit About</a>
  </div>
  <h1>Edit About</h1>
</div>
@endsection
...
<div class="widget-box">
  ...
  <div class="widget-content nopadding">
    <form class="form-horizontal" method="post" action="{{ route('tentang.edit') }}" name="basic_validate" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
      {{ csrf_field() }}
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <textarea name="visi" class="span9" id="visi">{{ old('visi', preg_replace('#<br\s*/?>#i', "\n", $getTentang->visi)) }}</textarea>
        </div>
      </div>
      <div class="control-group">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <textarea name="misi" class="span9" id="misi">{{ old('misi', preg_replace('#<br\s*/?>#i', "\n", $getTentang->misi)) }}</textarea>
        </div>
      </div>
