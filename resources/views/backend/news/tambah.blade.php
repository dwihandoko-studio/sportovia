...
<div class="widget-box">
  ...
  <div class="widget-content nopadding">
    <form class="form-horizontal" method="post" action="{{ route('news.store') }}" name="basic_validate" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
      {{ csrf_field() }}
      ...
      <div class="control-group {{ $errors->has('img_thumb') ? 'error' : '' }}">
        ...
        <div class="controls">
          <span>Width: 350px; Height: 200px</span>
        </div>
        <div class="controls">
